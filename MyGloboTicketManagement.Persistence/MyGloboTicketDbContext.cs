...
using MyGloboTicketManagement.Domain.Common;
using MyGloboTicketManagement.Domain.Entities;

namespace MyGloboTicketManagement.Persistence
{
    public class MyGloboTicketDbContext : DbContext
    {
        public MyGloboTicketDbContext(DbContextOptions<MyGloboTicketDbContext> options) : base(options) { }
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(MyGloboTicketDbContext).Assembly);
